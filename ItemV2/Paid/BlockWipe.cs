...
namespace Oxide.Plugins
{
    ...
    class BlockWipe : HurtworldPlugin
    {
        ...
        private void LoadDefaultMessages()
        {
            ...
            {
                {"timeblock","Предмет {item} заблокирован! {timemsg}"},
                {"timeleft","<color=red>[BlockWipe]</color> Кит {kitname} заблокирован! {timemsg}"},
                {"timemsg_hours","Осталось ждать {duration_hours} ч. {duration_min} м."},
                {"timemsg_minutes","Осталось ждать {duration} минут."},
                {"timemsg_seconds","Осталось ждать меньше минуты."}
            };
        ...
        protected override void LoadDefaultConfig()
        {
            ...
            _config = new Configuration()
            {
                ...
                {
                    new Configuration.Item_Block("C4","09.02.19 18:00"),
                    new Configuration.Item_Block("RaidDrill","09.02.19 16:00"),
                    new Configuration.Item_Block("AR15","09.02.19 15:00"),
                    new Configuration.Item_Block("Shotgun","09.02.19 15:00"),
                    new Configuration.Item_Block("AWM","09.02.19 16:00")
                },
